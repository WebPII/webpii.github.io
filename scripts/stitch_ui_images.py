...
def main():
    ...
    parser.add_argument("--input", "-i", type=str, default=str(BASE_DIR / "data" / "ui_images"),
    ...
    output_dir = BASE_DIR / "data" / "stitched_images"
    ...
    if args.output:
        ...
        output_path = str(output_dir / f"{company_clean}_{args.device}_stitched.png")
